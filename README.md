## gz_cmake_vendor (kilted) - 0.3.6-1

The packages in the `gz_cmake_vendor` repository were released into the `kilted` distro by running `/Users/addisuzt/ws/.venv/bin/bloom-release --rosdistro kilted gz_cmake_vendor -y` on `Fri, 04 Sep 2026 13:32:21 -0000`
...
## gz_cmake_vendor (kilted) - 0.3.5-1

The packages in the `gz_cmake_vendor` repository were released into the `kilted` distro by running `/Users/addisuzt/ws/.venv/bin/bloom-release --rosdistro kilted gz_cmake_vendor -y` on `Tue, 01 Sep 2026 02:30:20 -0000`
...
## gz_cmake_vendor (rolling) - 0.5.2-1

The packages in the `gz_cmake_vendor` repository were released into the `rolling` distro by running `/Users/addisuzt/ws/.venv/bin/bloom-release --rosdistro rolling gz_cmake_vendor` on `Tue, 25 Aug 2026 23:44:38 -0000`
...
## gz_cmake_vendor (jazzy) - 0.0.12-1

The packages in the `gz_cmake_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy gz_cmake_vendor` on `Wed, 17 Jun 2026 21:27:36 -0000`
...
## gz_cmake_vendor (kilted) - 0.3.4-1

The packages in the `gz_cmake_vendor` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted gz_cmake_vendor` on `Wed, 17 Jun 2026 20:16:03 -0000`
...
## gz_cmake_vendor (lyrical) - 0.4.5-1

The packages in the `gz_cmake_vendor` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical gz_cmake_vendor` on `Wed, 10 Jun 2026 16:33:29 -0000`
...
## gz_cmake_vendor (rolling) - 0.5.1-1

The packages in the `gz_cmake_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_cmake_vendor` on `Wed, 10 Jun 2026 16:22:29 -0000`
...
## gz_cmake_vendor (rolling) - 0.5.0-1

The packages in the `gz_cmake_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_cmake_vendor` on `Thu, 14 May 2026 02:07:54 -0000`
...
## gz_cmake_vendor (rolling) - 0.4.4-1

The packages in the `gz_cmake_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_cmake_vendor` on `Wed, 22 Apr 2026 14:21:05 -0000`
...
## gz_cmake_vendor (kilted) - 0.3.3-1

The packages in the `gz_cmake_vendor` repository were released into the `kilted` distro by running `/Users/addisuzt/ws/gz_vendor_pkgs/vendor_pkgs/.venv/bin/bloom-release --rosdistro kilted gz_cmake_vendor` on `Thu, 12 Feb 2026 22:13:09 -0000`
...
## gz_cmake_vendor (rolling) - 0.4.2-1

The packages in the `gz_cmake_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_cmake_vendor` on `Fri, 30 Jan 2026 19:48:16 -0000`
...
## gz_cmake_vendor (rolling) - 0.4.1-1

The packages in the `gz_cmake_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_cmake_vendor` on `Mon, 29 Sep 2025 20:50:36 -0000`
...
## gz_cmake_vendor (rolling) - 0.4.0-1

The packages in the `gz_cmake_vendor` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling gz_cmake_vendor` on `Mon, 08 Sep 2025 23:05:55 -0000`
...
## gz_cmake_vendor (kilted) - 0.3.2-1

The packages in the `gz_cmake_vendor` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit-track --rosdistro kilted gz_cmake_vendor` on `Fri, 05 Sep 2025 01:06:52 -0000`
...
## gz_cmake_vendor (rolling) - 0.3.1-1
